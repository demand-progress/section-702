...
const PhoneScriptCopy = (props) => {
    return (
        <div>
            ...
            <br />
            <p>Tell your House Rep: The proposed “USA Liberty Act,” H.R. 3989, needs wholesale improvements before you should consider supporting it.</p>
            <br />
            <p>Tell your Senators: Please co-sponsor and support the USA RIGHTS Act from Senators Paul and Wyden, which would stop warrantless spying on Americans.</p>
            <br />
            <p>Tell both: Any reauthorization of Section 702 of the FISA Amendments Act must include:</p>
            <ul id="points">
